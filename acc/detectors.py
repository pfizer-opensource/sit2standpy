...
class PosiStill:
    ...
    def apply(self, raw_acc, mag_acc, mag_acc_r, time, dt, power_peaks, cwt_coefs, cwt_freqs):
        # find where the accelerometer is still
        acc_still, still_stops = PosiStill._stillness(mag_acc, dt, self.mov_window, self.grav,
        ...
        if self.strict:
            for ppk in power_peaks:
                ...
                if end_still < prev_int_start or start_still > prev_int_stop:
                    v_vel, v_pos = PosiStill._get_position(v_acc[end_still:start_still] - self.grav, dt, still_at_end)
            ...
            for ppk in power_peaks:
                ...
                # integrate
                if end_still < prev_int_start or start_still > prev_int_stop:
                    v_vel, v_pos = PosiStill._get_position(v_acc[end_still:start_still] - self.grav, dt,
                                                                   still_at_end)
